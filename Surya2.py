...
admin=["u5270245ab217708580c3d17eb1805498"]
creator=["u5270245ab217708580c3d17eb1805498"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~_aigo_",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~_aigo_",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u5270245ab217708580c3d17eb1805498"}
					cl.sendMessage(msg)
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"mbeb mana ya , gw jadi kangen sama dia")
...
#-----------------------------------------------
				...
				kk.sendText(msg.to,"Mamam 􀜁􀅔Har Har􏿿")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by @•☠͜͡✪✧AɨɢÕzzA✧✪͜͡☠•")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line://ti/p/~_aigo_")
						print "DiLike"
					except:
							pass
				else:
